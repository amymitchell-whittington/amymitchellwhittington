...
A point for me to remember: If I want to count every n consecutive numbers (as I did for this), I need to use ```colSums```. If I want to sum every nth number, I need to use ```rowSums```, but this will only work if n divides ```length(v)```.
