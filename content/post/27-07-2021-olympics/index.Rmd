...
This week I struggled quite a bit with trying to work out how to fix the spacing issues between points on the graph - I'll continue t tinker for a few days to see if I can solve the issue.
